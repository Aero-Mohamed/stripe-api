...
return [
    ...
    'description' => 'Comprehensive API documentation for ' . config('app.name') . '.', // Add a short description
    ...
    'auth' => [
        ...
        'extra_info' => 'Retrieve your token by logging in and visiting the API settings page.',
    ],
...
INTRO
    ...
    // so make sure it points to an accessible URL or path. Set false to not use a logo.
    ...
    'last_updated' => 'Last updated: {date:F j, Y} ({git:short})', // Show date and short git hash
